const lqOptions = {
    options: {
        ...
        rotateRightIcon: 'el-icon-refresh-right',
        rotateLeftIcon: 'el-icon-refresh-left',
        deleteIcon: 'el-icon-delete-solid',
        changeIcon: 'el-icon-document',
        cropIcon: 'el-icon-crop',
